...
<img src="/assets/itysl/itysl_ranking_v3.png" height="1200">
...
<div class="imgcap" style="text-align:center">
<img src="/assets/itysl/ranking_mine_v2.png" height="200">
<div class="thecap" style="text-align:center">Table 1. Top 10 skits, according to my rankings</div></div>
&nbsp;
&nbsp;

<div class="imgcap" style="text-align:center">
<img src="/assets/itysl/ranking_aggregate_v2.png" height="200">
...
## Data sources
You can easily load the data from myself and the 8 websites below in python by running: `pandas.read_csv('https://docs.google.com/spreadsheets/d/1ohrGvph_ALF7NICLiDsa3g-ZnNKUhcDC1DpLdYC7jrE/export?format=csv')`.
...
- https://www.rollingstone.com/tv-movies/tv-movie-lists/i-think-you-should-leave-tim-robinson-every-sketch-ranked-1234770232/ 
- https://www.theringer.com/tv/2021/7/20/22583930/i-think-you-should-leave-sketches-ranking 
